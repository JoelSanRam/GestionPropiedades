...
<form action="{{ route('create-archivo') }}" method="POST" class="form-control-with-bg">
    @csrf
    <div class="jumbotron my-5 py-3">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-3">
                ...
                <input name="pdf" type="text" class="form-control" placeholder="Ingresar nombre del pdf">
            </div>
            <div class="form-group col-md-3">
                <label>Nombre del DWG</label>
                <input name="dwg" type="text" class="form-control" placeholder="Ingresar nombre del dwg" >
            </div>
        </div>
